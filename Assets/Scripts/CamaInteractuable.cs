...
public class CamaInteractuable : MonoBehaviour
{
    ...
    [Tooltip("Texto que se mostrar� al mirar la cama. Ej: 'Dormir (E)'")]
    public string textoIndicador = "Dormir [E]"; // Texto personalizable
    [Tooltip("Arrastra aqu� el MISMO prefab de Canvas flotante que usas para ingredientes/puertas.")]
    ...
    // No es estrictamente necesario aqu�, ya que la llamada se hace desde InteraccionJugador,
    // pero podr�a ser �til para otras l�gicas de la cama.
